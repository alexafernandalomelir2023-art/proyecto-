...
function mostrarProductos() {
  ...
  // Mostrar productos del JSON (con botón de eliminar)
  productosBase.forEach((producto, index) => {
    ...
    div.innerHTML = `
      ...
      <button class="eliminar" onclick="eliminarProductoBase(${index})">Eliminar</button>
    `;
...
// Eliminar productos del JSON
function eliminarProductoBase(index) {
